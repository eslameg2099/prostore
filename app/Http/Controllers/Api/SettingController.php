    ...
    public function index()
    {
        return response()->json([
            ...
            'pages' => [
                ...
                'shop_terms' => [
                    'link' => route('api.settings.page', ['shop_terms', 'language' => app()->getLocale()]),
                    'content' => Settings::locale()->get('shop_terms'),
                ],
              
                'customer_terms' => [
                    'link' => route('api.settings.page', ['customer_terms', 'language' => app()->getLocale()]),
                    'content' => Settings::locale()->get('customer_terms'),
                ],
                'privacy' => [
