<x-layout :title="trans('addresses.plural')" :breadcrumbs="['dashboard.addresses.index']">
    ...
    @component('dashboard::components.table-box')
          ...
          <th colspan="100">
            <div class="d-flex">
                <x-check-all-delete
                        ...
                        :resource="trans('addresses.plural')"></x-check-all-delete>

                <div class="ml-2 d-flex justify-content-between flex-grow-1">
                    @include('dashboard.addresses.partials.actions.create')
                    @include('dashboard.addresses.partials.actions.trashed')
                </div>
            </div>
          </th>
        </tr>
        ...
        @forelse($addresses as $address)
            <tr>
                ...
                <td>
                    <a href="{{ route('dashboard.addresses.show', $address) }}"
