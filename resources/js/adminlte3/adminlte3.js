...
Vue.component('nested-select', require('../components/NestedSelectComponent').default);
Vue.component('categories-select', require('../components/CategoriesSelectComponent').default);
Vue.component('colors-component', require('../components/ColorsComponent').default);
Vue.component('sizes-component', require('../components/SizesComponent').default);
Vue.component('selectdelaget', require('../components/selectdelaget').default);
